...
=================================*/}
        <div
          ...
          style={{
            backgroundImage:
              'url("https://cdn.shopify.com/s/files/1/2083/7711/files/bonding-1985863.jpg?7305656213290828124")',
            boxShadow: 'inset 0 0 0 2000px rgba(0,0,0,0.6)',
          }}
        >
          <div className='container special'>
            <div className='jumbotron'>
              <span className='fwbg-title'> About Active Swag </span>
              <div className='headline-container'>
                <div className='row'>
                  <div className='col-xs-12'>
                    <span className='fwbg-callout'>&nbsp;</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className='row'>
            ...
            <div className='col-xs-12 col-sm-8 col-md-6'>
              <div className='info-text'>
                <p>
                  We know how important it is to make a meaningful connection
                  with your customer or consumer and that the right promotional
                  product is part of the equation. The Swag Team at Active
                  International is your dedicated resource for branded premiums,
            ...
            <div className='row'>
              <div className='col-xs-12 col-sm-8 col-sm-push-4 col-md-6 col-md-push-6'>
                <div className='info-text right'>
                  <p>
                    With more than a decade of experience working with media
                    companies, retailers and manufacturers, our goal is to make
                    sure your experience is exceptional, whether we’re
                    recommending new ideas, managing creative or ensuring
                    fulfillment.
                  </p>
                </div>
              </div>
            ...
            <div className='row'>
              ...
              >
                ...
                <div className='col-xs-12 col-sm-6 col-md-4'>
                  <figure className='snip0078 blue'>
                    <img
                ...
                <div className='col-xs-12 col-sm-6 col-md-4'>
                  <figure className='snip0078 red'>
                    ...
                    <figcaption>
                      <h2>
                        Budget Friendly <span>Ideas</span>
                      </h2>
                    </figcaption>
                    <a href='#' />
                  </figure>
                ...
                <div className='col-xs-12 col-sm-6 col-md-4'>
                  <figure className='snip0078 yellow'>
                    <img
                    ...
                    <figcaption>
                      <h2>
                        Customized <span> Proposals</span>
                      </h2>
                    </figcaption>
                    <a href='#' />
                  </figure>
